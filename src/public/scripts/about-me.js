import {
    fade_element_in,
    fade_element_out,
    fade_multiple_elements_in,
    fade_multiple_elements_out,
    get_hex_color,
    get_RGBA_color,
    LuckyDip,
} from "./index.js";
...
function show_email() {
    ...
    email.innerHTML =
        "antony<!-- 123stopspam -->35<span class='spam-protection'>Stop trying to steal my email, thanks.</span>007@gma<!-- 123stopspam -->il.com";
